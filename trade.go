...
// TradeType은 체결 정보의 타입을 정의합니다
type TradeType string

const (
	TradeTypeSnapshot TradeType = "SNAPSHOT" // 스냅샷 데이터
	TradeTypeRealtime TradeType = "REALTIME" // 실시간 데이터
)

// AskBidType은 매수/매도 구분을 정의합니다
...
type Trade struct {
	...
	StreamType       TradeType  `json:"stream_type"`        // 스트림 타입
}
